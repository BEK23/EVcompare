...
export const NewsItem = (news: INews) => {
  return (
    <div className="relative h-[490px] animate-fade-up overflow-hidden rounded-[1.25rem] border bg-background transition duration-500 hover:scale-105 group-hover/disabled:scale-100">
      <div
